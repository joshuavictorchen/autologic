...
- **`questionary` dependency in `participant.py`** — used for CLI prompts on no-show special assignments; unexpected in a GUI app. May cause issues in headless/test contexts.
